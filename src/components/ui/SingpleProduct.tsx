    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-8">
          <h1 className="text-3xl text-[#010E13] font-bold mb-4">{product.title}</h1>
          <p className="text-[#010E13] text-xl mb-4">{product.category}</p>
          ...
          <div className="flex items-center mb-4">
            ...
            />
            <span className="ml-2 text-[#010E13]">({product.rating.count} reviews)</span>
          </div>
          {/* <p className="mb-4"><strong>Brand:</strong> {product.brand}</p> */}
          {/* <p className="mb-4"><strong>In Stock:</strong> {product.stock}</p> */}
          <p className="text-[#010E13] text-lg mb-6">{product.description}</p>
          <button
